...
from openitcockpit_mcp.api.scope.validate import (
...
class ScopeService:
    ...
    def validate_container_legal_for(self, object_type: str, container_id: int, field_label: str, submitted_name: str) -> None:
