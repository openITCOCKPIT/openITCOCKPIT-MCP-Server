"""The get_allowed_elements_for_container tool: Allowed Elements for Container."""
...
from openitcockpit_mcp.tools.support.params import ContainerName, ScopedObjectType
...
def register(mcp: FastMCP, deps: Deps) -> None:
    ...
    @mcp.tool(title="Allowed Elements for Container", annotations=ANNOTATIONS)
    def get_allowed_elements_for_container(object_type: ScopedObjectType, container_name: ContainerName = "") -> dict:
