...
READ_CALLS = {
    ...
    "find_noisy_checks": {},
    "explain_notification": {"hostname": "web01"},
    "get_shift_summary": {},
...
WRITE_CALLS = {
    ...
    "update_service": {"hostname": "web01", "servicename": "Ping", "fields": {"check_interval_seconds": 60}},
    ...
    "apply_configuration": {},
    "stop_monitoring": {"hostname": "web01"},
    "resume_monitoring": {"hostname": "web01"},
    "delete_object": {"hostname": "web01"},
